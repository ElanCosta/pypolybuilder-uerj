...
class OptimizeGeometry(object):
    ...
    def printAbsForces(self,i):
        print(str(i) + "    " + str(self.totalBonds) + "   " + str(self.totalAngles[0]) + "   " + str(
            self.totalAngles[1]) + "   " + str(self.totalAngles[2]) + "   " + str(self.totalLJ))
        self.totalBonds = 0.0
        self.totalLJ = 0.0
        self.totalAngles = [0.0, 0.0, 0.0]
    ...
    def run(self):
        ...
        while(i < self.numberOfSteps):
            ...
            #print(str(i) + "    " + str(self.totalBonds) + "   " + str(self.totalAngles[0]) + "   " + str(self.totalAngles[1]) + "   " + str(self.totalAngles[2]) + "   " + str(self.totalLJ))
            i = i + 1
            self.currstep = i
